...
<html lang="en"  class="height-full"data-color-mode="auto" data-light-theme="light" data-dark-theme="dark">
  ...
  <meta name="request-id" content="C0E6:6A49:5EE7E1:B4B0D4:60832603" data-pjax-transient="true"/><meta name="html-safe-nonce" content="1cd0f425ef50d63593ba0c4a1e928369f0d7310eeade5af7880f6082829b67d1" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHA6Ly9naXRodWIuY29tL3NvbGUvdHdlZW4uanMiLCJyZXF1ZXN0X2lkIjoiQzBFNjo2QTQ5OjVFRTdFMTpCNEIwRDQ6NjA4MzI2MDMiLCJ2aXNpdG9yX2lkIjoiMzE0MTc3NDA0MTg0MTYwNzA3NSIsInJlZ2lvbl9lZGdlIjoiaWFkIiwicmVnaW9uX3JlbmRlciI6ImlhZCJ9" data-pjax-transient="true"/><meta name="visitor-hmac" content="3d7917677a0319e64efd15cbcd7bdc9c94a0e98f1b9acec8ee9e21f9e395adf8" data-pjax-transient="true"/>
      ...
      <div class="d-flex flex-justify-between flex-items-center width-full">
        <a href="https://github.com/" aria-label="Homepage">
          ...
          <div class="font-mktg">
            ...
            <a href="/login?return_to=%2Fjoin_next%3Fref_cta%3DSign%2Bup%26ref_loc%3Dheader%2Blogged%2Bout%26ref_page%3D%252F%253Cuser-name%253E%252F%253Crepo-name%253E%26source%3Dheader-repo%26source_repo%3Dsole%252Ftween.js" class="color-text-white">
              Log in →
            </a>
          </div>
      </div>
...
<text-suggester class="js-continue-container width-full z-1" style="max-width: 654px;">
  ...
  >
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative js-octocaptcha-parent" action="/join_next" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="Y878/N5RSmM6OZod0eUPnTHpyg+qaLgxnAoJ5hzCVafmkWSr3+VtjnMSCbLj9l2CpH2BYCpZdYQ+Y0hHeQOB4w==" />
      <div
        id="email-container"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/email_validity_checks" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="jhysJNfiXl8JUnaG8w1TWkxBm/MFf1sh+m/AyAg1rzUOgZ1vvzNBi9RB+9xPPLQhzqO0G/tip96ZxjWD95wNTg==" />
            </auto-check>
          </div>
          <button
            type="button"
          ...
          <div class="d-flex flex-items-center width-full">
            ...
            <visible-password class="flex-1 d-flex flex-items-center mr-3">
              ...
              >
                ...
                <input type="hidden" data-csrf="true" value="o9OSR+7rvsrs2sVH13jRgTejLfw6HZEJQ2MpM/VhGrK7F4gO33npYHkkrWBCj58R0EQCApNoFF0itYSUUpevzg==" />
              </auto-check>
              <button
                type="button"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/signup_check/username" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="JrRGNPUsYgq9V9I/WqRyJX8MCv3qHmRFsvpdULwF1Owoi7uzFvjWlcOw3jjEMnm/tnJhxgMYVHf3lnNhtXFMjA==" />
            </auto-check>
          </div>
          <button
            type="button"
...
<div class="my-3" >
  ...
  >
        ...
        <input class="form-control" type="text" name="required_field_04d2" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1619207683196" />
<input class="form-control" type="hidden" name="timestamp_secret" value="a8e1a8f62d10cd99cf10bbc175ddeee66c9c52c33919269b357dfbc7b67019e0" />
