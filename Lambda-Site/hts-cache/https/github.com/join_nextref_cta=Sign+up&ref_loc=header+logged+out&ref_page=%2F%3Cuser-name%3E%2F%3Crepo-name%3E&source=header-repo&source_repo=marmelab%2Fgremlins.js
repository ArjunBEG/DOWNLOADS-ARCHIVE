...
<html lang="en"  class="height-full"data-color-mode="auto" data-light-theme="light" data-dark-theme="dark">
  ...
  <meta name="request-id" content="D1BB:57EF:C89D27:1359EC2:60833AA1" data-pjax-transient="true"/><meta name="html-safe-nonce" content="1cd0f425ef50d63593ba0c4a1e928369f0d7310eeade5af7880f6082829b67d1" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHA6Ly9naXRodWIuY29tL21hcm1lbGFiL2dyZW1saW5zLmpzIiwicmVxdWVzdF9pZCI6IkQxQkI6NTdFRjpDODlEMjc6MTM1OUVDMjo2MDgzM0FBMSIsInZpc2l0b3JfaWQiOiIzMTQxNzc0MDQxODQxNjA3MDc1IiwicmVnaW9uX2VkZ2UiOiJpYWQiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=" data-pjax-transient="true"/><meta name="visitor-hmac" content="9eb249956e99a8c224bc59060a503cde43bbc988acd7e0bd12d0e4cab212daab" data-pjax-transient="true"/>
  ...
  <link crossorigin="anonymous" media="all" integrity="sha512-PMBdoaqHWlIKbdEAmzhfWN3JFUehBNuQhpgp01JkcvQlh34X0un4Jzty4jQqsdEIBdppBGBw+DV24QQY4ExANw==" rel="stylesheet" href="https://github.githubassets.com/assets/home-3cc05da1aa875a520a6dd1009b385f58.css" />
      ...
      <div class="d-flex flex-justify-between flex-items-center width-full">
        <a href="https://github.com/" aria-label="Homepage">
          ...
          <div class="font-mktg">
            ...
            <a href="/login?return_to=%2Fjoin_next%3Fref_cta%3DSign%2Bup%26ref_loc%3Dheader%2Blogged%2Bout%26ref_page%3D%252F%253Cuser-name%253E%252F%253Crepo-name%253E%26source%3Dheader-repo%26source_repo%3Dmarmelab%252Fgremlins.js" class="color-text-white">
              Log in →
            </a>
          </div>
      </div>
...
<text-suggester class="js-continue-container width-full z-1" style="max-width: 654px;">
  ...
  >
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative js-octocaptcha-parent" action="/join_next" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="/TItnGVJpoqhr3FjLaXg7wMgCZeb8ozy3w5amVXfweB4bbXLZP2BZ+iE4swftrLwlrRC+BvDQUd9Zxs4MB4VpA==" />
      <div
        id="email-container"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/email_validity_checks" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="kv+TDG+ytCpSL8rivs0tZj2JYxcGd8Q1vcWVKPztx1ASYqJHB2Or/o88R7gC/Modv2tM//hqOMrebGBjA0RlKw==" />
            </auto-check>
          </div>
          <button
            type="button"
          ...
          <div class="d-flex flex-items-center width-full">
            ...
            <visible-password class="flex-1 d-flex flex-items-center mr-3">
              ...
              >
                ...
                <input type="hidden" data-csrf="true" value="WzL+deVxhlKTaV+gsKcT4sWHKL1Opn3HtXnSn9Nrg/ZD9uQ81OPR+AaXN4clUF1yImAHQ+fT+JPUr384dJ02ig==" />
              </auto-check>
              <button
                type="button"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/signup_check/username" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="0HCuBqie5haA/9sERBU0nBKtLAHiJZWgLqr9yiaawHbeT1OBS0pSif4Y1wPagz8G29NHOgsjpZJrxtP7L+5YFg==" />
            </auto-check>
          </div>
          <button
            type="button"
...
<div class="my-3" >
  ...
  >
        ...
        <input class="form-control" type="text" name="required_field_9207" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1619212961470" />
<input class="form-control" type="hidden" name="timestamp_secret" value="54e8995b84343d664841372fa96b1d366b1bad0c45313cad1a9ea08f66147362" />
