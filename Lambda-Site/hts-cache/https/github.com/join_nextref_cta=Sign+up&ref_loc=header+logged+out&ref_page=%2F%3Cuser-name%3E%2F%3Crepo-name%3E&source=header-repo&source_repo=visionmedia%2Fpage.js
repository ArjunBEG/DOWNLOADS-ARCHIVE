...
<html lang="en"  class="height-full"data-color-mode="auto" data-light-theme="light" data-dark-theme="dark">
  ...
  <script crossorigin="anonymous" defer="defer" integrity="sha512-WTSd4u3TiWf+Bqfb/7bTnzyDbSBftqePECjIOCGOCx9n2L8aE4zNYknWYK5zR1D4ELghJcW3SS9jGbqTt50aCw==" type="application/javascript" src="https://github.githubassets.com/assets/behaviors-59349de2.js"></script>
    ...
    <script crossorigin="anonymous" defer="defer" integrity="sha512-7wqq7AkV5tsq8+jZTIGW0HAYm4IbCrdTVCunAjHEGVz65smN77WzxFpZDtp3WB7gzk3ImLqVfh/2WRqbQLzjww==" type="application/javascript" src="https://github.githubassets.com/assets/signup-redesign-ef0aaaec.js"></script>
  <script crossorigin="anonymous" defer="defer" integrity="sha512-HHb0nwuuZvGKnuS0pT2shMfSpozZLci54grVBV/lgB3EKNL9cjDQRC9Z7tQZt36Xo+M8B1C72MAnGeWoQYHWYg==" type="application/javascript" src="https://github.githubassets.com/assets/signup-1c76f49f.js"></script>
  ...
  <meta name="request-id" content="C236:1E8D:9F6618:10D8E5B:6083264A" data-pjax-transient="true"/><meta name="html-safe-nonce" content="1cd0f425ef50d63593ba0c4a1e928369f0d7310eeade5af7880f6082829b67d1" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHA6Ly9naXRodWIuY29tL3Zpc2lvbm1lZGlhL3BhZ2UuanMiLCJyZXF1ZXN0X2lkIjoiQzIzNjoxRThEOjlGNjYxODoxMEQ4RTVCOjYwODMyNjRBIiwidmlzaXRvcl9pZCI6IjMxNDE3NzQwNDE4NDE2MDcwNzUiLCJyZWdpb25fZWRnZSI6ImlhZCIsInJlZ2lvbl9yZW5kZXIiOiJpYWQifQ==" data-pjax-transient="true"/><meta name="visitor-hmac" content="75fec8802c56c9b1404ad5d442cfe9af0f70c868664274ee3183e084b463c7e9" data-pjax-transient="true"/>
  ...
  <meta name="selected-link" value="/join_next" data-pjax-transient>
  ...
  <meta http-equiv="x-pjax-version" content="f197936efb8a5e1233c0cd7a7567e337085156fa2aa099eeba0d884c9ba4bf32">
  ...
  <link crossorigin="anonymous" media="all" integrity="sha512-IwVpuoSz/LZES3qlcZ8kswcyBRRZkySCz5DxJ0vE5g6D9qO7rcxNrQJ3ccX8oQaUA9smzSzZyULbo30BAFC8fQ==" rel="stylesheet" href="https://github.githubassets.com/assets/home-230569ba84b3fcb6444b7aa5719f24b3.css" />
...
<meta name="color-scheme" content="light dark" />
    ...
    <div class="container-xl d-lg-flex flex-items-center p-responsive">
      <div class="d-flex flex-justify-between flex-items-center width-full">
        <a href="https://github.com/" aria-label="Homepage">
          ...
          <div class="font-mktg">
            <span class="mr-2 text-gray-mktg">Already have an account?</span>
            <a href="/login?return_to=%2Fjoin_next%3Fref_cta%3DSign%2Bup%26ref_loc%3Dheader%2Blogged%2Bout%26ref_page%3D%252F%253Cuser-name%253E%252F%253Crepo-name%253E%26source%3Dheader-repo%26source_repo%3Dvisionmedia%252Fpage.js" class="color-text-white">
              Log in →
            </a>
          </div>
      </div>
  ...
  >
        <main class="bg-gray-dark-mktg d-flex flex-auto flex-column overflow-hidden position-relative">
    <div>
      <div class="stars"></div>
...
<text-suggester class="js-continue-container width-full z-1" style="max-width: 654px;">
  <div
    class="m-4 p-4 f4 color-shadow-small bg-gray-800-mktg border rounded-2"
  ...
  >
      ...
      >
        <span
          ...
          class="text-mono text-gray-mktg"
        ></span>
        <span
    ...
    <noscript>
      <div class="my-4 text-mono color-text-warning">
        GitHub requires JavaScript enabled to sign up for our captcha. Please enable JavaScript.
      </div>
    </noscript>

    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative js-octocaptcha-parent" action="/join_next" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="Ox7J0hlzIwpOmIjPuZuDeBDl8Y11o16FWzOplAwZO0i+QVGFGMcE5wezG2CLiNFnhXG64vWSkzD5Wug1adjvDA==" />
      <div
        id="email-container"
        class="js-continue-step-container signup-continue-step-container my-4"
        data-step-state="active"
        hidden
      >
        <div>
          <label for="email" class="text-mono" style="color: #00CFC8;">
            Enter your email
          </label>
        </div>
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/email_validity_checks" class="js-prevent-default-behavior width-full" required>
              <input id="email" class="js-continue-input js-continue-focus-target signup-input form-control input-block flex-1 border-0 rounded-0 p-0 box-shadow-none color-text-white f4 text-mono" required="required" autofocus="autofocus" data-target="text-suggester.input" type="email" name="user[email]" />
              <input type="hidden" data-csrf="true" value="/R6EtRYfThEwPMiHeav1bSamXWcFFHjyn3Kz7Fq9mAZ9g7X+fs5Rxe0vRd3FmhIWpERyj/sJhA3820anpRQ6fQ==" />
            </auto-check>
          </div>
          <button
            type="button"
      ...
      <div
        ...
        class="js-continue-step-container signup-continue-step-container mb-4"
        hidden
      >
        <div>
          <label for="password" class="text-mono" style="color: #00CFC8;">
            Create a password
          </label>
        </div>
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <visible-password class="flex-1 d-flex flex-items-center mr-3">
              <auto-check
                src="/password_validity_checks"
                class="js-prevent-default-behavior flex-1"
                required
              >
                <input id="password" class="form-control js-continue-input js-continue-focus-target signup-input form-control input-block flex-1 border-0 rounded-0 p-0 box-shadow-none color-text-white f4 text-mono" required="required" autocomplete="new-password" data-target="visible-password.input" type="password" name="user[password]" />
                <input type="hidden" data-csrf="true" value="VqXcBRPs10xtFZa5jdNbrqKq9qseWi1fbjLqIrRkQ9BOYcZMIn6A5vjr/p4YJBU+RU3ZVbcvqAsP5EeFE5L2rA==" />
              </auto-check>
              <button
                type="button"
      ...
      <div
        ...
        class="mb-4 js-continue-step-container signup-continue-step-container"
        hidden
      >
        <div>
          <label for="login" class="text-mono" style="color: #00CFC8;">
            Enter a username
          </label>
        </div>
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/signup_check/username" class="js-prevent-default-behavior width-full" required>
              <input id="login" class="form-control js-continue-input js-continue-focus-target signup-input form-control input-block flex-1 border-0 rounded-0 p-0 box-shadow-none color-text-white f4 text-mono" required="required" type="text" name="user[login]" />
              <input type="hidden" data-csrf="true" value="u38+fI+BcSu4CYoB7trWB68xsOqZqdwGodJ9jKXvJ1m1QMP7bFXFtMbuhgZwTN2dZk/b0XCv7DTkvlO9rJu/OQ==" />
            </auto-check>
          </div>
          <button
            type="button"
      ...
      <div id="captcha-and-submit-container" class="width-full js-continue-step-container" style="position: absolute;top: -10000px">
          <span class="text-mono text-bold" style="color: #00CFC8;">
            Verify your account
          </span>
          <div class="js-continue-focus-target mt-n5 mb-4" tabindex="-1" style="outline: none;">
...
<div class="my-3" >
  ...
  >
    <iframe src="https://octocaptcha.com?origin_page=github_signup_next&amp;responsive=true&amp;require_ack=true&amp;version=2" class="js-octocaptcha-frame width-full d-block border-0" title="Please verify by completing this captcha." style="height: 0"></iframe>
  </div>
  <input
    required
    ...
    data-octocaptcha-loaded-height="380"
  >
</div>

          </div>

        <input class="form-control" type="text" name="required_field_bbd1" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1619207754320" />
<input class="form-control" type="hidden" name="timestamp_secret" value="972e5e43386996d35b37002be38d1d480577f003bd3715e81ead21799d9baf7f" />


        <button name="button" type="submit" class="form-control signup-submit-button width-full py-2 js-octocaptcha-form-submit" style="background: none;" data-optimizely-event="click.signup_continue.create_account" data-disable-invalid="true" disabled="disabled" hidden="hidden">Create account</button>
      </div>
</form>  </div>
  <div class="js-continue-hint-container mx-4 px-4 f4 font-mktg text-gray-mktg">
    <div data-hint-for="email"></div>
    <div data-hint-for="password"></div>
    <div data-hint-for="login"></div>
  </div>
</text-suggester>

    </div>

      <div class="d-flex flex-content-end flex-justify-center">
        <div class="mb-6" style="max-width: 654px;">
          <p class="text-gray-mktg text-small m-4">
    ...
    <img
      ...
      class="position-absolute overflow-hidden home-hero-glow events-none"
    >
  </main>
