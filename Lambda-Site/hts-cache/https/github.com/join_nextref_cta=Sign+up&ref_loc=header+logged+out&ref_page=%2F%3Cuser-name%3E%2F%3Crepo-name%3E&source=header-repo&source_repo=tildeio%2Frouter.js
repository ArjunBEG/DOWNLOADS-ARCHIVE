...
<html lang="en"  class="height-full"data-color-mode="auto" data-light-theme="light" data-dark-theme="dark">
  ...
  <meta name="request-id" content="C2F5:0557:92C484:F7ACB8:6083266D" data-pjax-transient="true"/><meta name="html-safe-nonce" content="1cd0f425ef50d63593ba0c4a1e928369f0d7310eeade5af7880f6082829b67d1" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHA6Ly9naXRodWIuY29tL3RpbGRlaW8vcm91dGVyLmpzIiwicmVxdWVzdF9pZCI6IkMyRjU6MDU1Nzo5MkM0ODQ6RjdBQ0I4OjYwODMyNjZEIiwidmlzaXRvcl9pZCI6IjMxNDE3NzQwNDE4NDE2MDcwNzUiLCJyZWdpb25fZWRnZSI6ImlhZCIsInJlZ2lvbl9yZW5kZXIiOiJpYWQifQ==" data-pjax-transient="true"/><meta name="visitor-hmac" content="f4cc0eb22f022357ff8242d4679c5d45a34d69d6899bcf59e42bc274a70b34f2" data-pjax-transient="true"/>
      ...
      <div class="d-flex flex-justify-between flex-items-center width-full">
        <a href="https://github.com/" aria-label="Homepage">
          ...
          <div class="font-mktg">
            ...
            <a href="/login?return_to=%2Fjoin_next%3Fref_cta%3DSign%2Bup%26ref_loc%3Dheader%2Blogged%2Bout%26ref_page%3D%252F%253Cuser-name%253E%252F%253Crepo-name%253E%26source%3Dheader-repo%26source_repo%3Dtildeio%252Frouter.js" class="color-text-white">
              Log in →
            </a>
          </div>
      </div>
...
<text-suggester class="js-continue-container width-full z-1" style="max-width: 654px;">
  ...
  >
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative js-octocaptcha-parent" action="/join_next" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="8lZYiwpItGrz+cSYhGdz/8RuWtq0EgIc9VaPIqipWjB3CcDcC/yTh7rSVze2dCHgUfoRtTQjz6lXP86DzWiOdA==" />
      <div
        id="email-container"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/email_validity_checks" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="PXCf3OjQ1IhCe2E9fASO1aYE9HX9V0jWixujPuW0Ys+97a6XgAHLXJ9o7GfANWmuJObbnQNKtCnoslZ1Gh3AtA==" />
            </auto-check>
          </div>
          <button
            type="button"
          ...
          <div class="d-flex flex-items-center width-full">
            ...
            <visible-password class="flex-1 d-flex flex-items-center mr-3">
              ...
              >
                ...
                <input type="hidden" data-csrf="true" value="AIW1z9OwNSMln3u8LK5hU2CzEV7HiWVBdUOO6hf8j0sYQa+G4iJiibBhE5u5WS/Dh1Q+oG784BUUlSNNsAo6Nw==" />
              </auto-check>
              <button
                type="button"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/signup_check/username" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="ukxQuwNk+bmmsuVvoFOv1S+n0pPFKnEMOBKkkiyQKdG0c6084LBNJthV6Wg+xaRP5tm5qCwsQT59foqjJeSxsQ==" />
            </auto-check>
          </div>
          <button
            type="button"
...
<div class="my-3" >
  ...
  >
        ...
        <input class="form-control" type="text" name="required_field_5261" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1619207789829" />
<input class="form-control" type="hidden" name="timestamp_secret" value="ac12c88334fdf77d536b15bfef3c424263bcd2cec923bb960fb8c9b19f72b0af" />
