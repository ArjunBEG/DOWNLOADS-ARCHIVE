...
<html lang="en"  class="height-full"data-color-mode="auto" data-light-theme="light" data-dark-theme="dark">
  ...
  <meta name="request-id" content="C548:342F:5CF63E:B3025C:60832720" data-pjax-transient="true"/><meta name="html-safe-nonce" content="1cd0f425ef50d63593ba0c4a1e928369f0d7310eeade5af7880f6082829b67d1" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHA6Ly9naXRodWIuY29tL3pvbHRhbi1kdWxhYy9odG1sNUZvcm1zLmpzIiwicmVxdWVzdF9pZCI6IkM1NDg6MzQyRjo1Q0Y2M0U6QjMwMjVDOjYwODMyNzIwIiwidmlzaXRvcl9pZCI6IjMxNDE3NzQwNDE4NDE2MDcwNzUiLCJyZWdpb25fZWRnZSI6ImlhZCIsInJlZ2lvbl9yZW5kZXIiOiJpYWQifQ==" data-pjax-transient="true"/><meta name="visitor-hmac" content="6c3bdc0c3c1cdb3e5974c0486e20e2bbfced6aec2aac4b84e0d457300be90d37" data-pjax-transient="true"/>
      ...
      <div class="d-flex flex-justify-between flex-items-center width-full">
        <a href="https://github.com/" aria-label="Homepage">
          ...
          <div class="font-mktg">
            ...
            <a href="/login?return_to=%2Fjoin_next%3Fref_cta%3DSign%2Bup%26ref_loc%3Dheader%2Blogged%2Bout%26ref_page%3D%252F%253Cuser-name%253E%252F%253Crepo-name%253E%26source%3Dheader-repo%26source_repo%3Dzoltan-dulac%252Fhtml5Forms.js" class="color-text-white">
              Log in →
            </a>
          </div>
      </div>
...
<text-suggester class="js-continue-container width-full z-1" style="max-width: 654px;">
  ...
  >
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative js-octocaptcha-parent" action="/join_next" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="OdL8c49LS+GqJwNSz4fd9bjcJvu1LQHI1B59O+uwz6u8jWQkjv9sDOMMkP39lI/qLUhtlDUczH12dzyajnEb7w==" />
      <div
        id="email-container"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/email_validity_checks" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="OXj27I0J4hVEUrUc9IoNhX+NBDEZ6PGLl2ISNC4XlRG55cen5dj9wZlBOEZIu+r+/W8r2ef1DXT0y+d/0b43ag==" />
            </auto-check>
          </div>
          <button
            type="button"
          ...
          <div class="d-flex flex-items-center width-full">
            ...
            <visible-password class="flex-1 d-flex flex-items-center mr-3">
              ...
              >
                ...
                <input type="hidden" data-csrf="true" value="2UHuIVv8caRwD/e1fpJ7uVf6UzMd587ClcmPd2Qwt1fBhfRoam4mDuXxn5LrZTUpsB18zbSSS5b0HyLQw8YCKw==" />
              </auto-check>
              <button
                type="button"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/signup_check/username" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="ZckRNcJ50KKGHY+owkZcipWgRRJg19srnSKM/tC/k41r9uyyIa1kPfj6g69c0FcQXN4uKYnR6xnYTqLP2csL7Q==" />
            </auto-check>
          </div>
          <button
            type="button"
...
<div class="my-3" >
  ...
  >
        ...
        <input class="form-control" type="text" name="required_field_d279" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1619207968749" />
<input class="form-control" type="hidden" name="timestamp_secret" value="0d55923ddc4b51560c78612ff2e485bb25fdef110c6d1586a70911aae675b241" />
