...
<html lang="en"  class="height-full"data-color-mode="auto" data-light-theme="light" data-dark-theme="dark">
  ...
  <meta name="request-id" content="C345:39F3:206A7F:5D71BC:6083268D" data-pjax-transient="true"/><meta name="html-safe-nonce" content="1cd0f425ef50d63593ba0c4a1e928369f0d7310eeade5af7880f6082829b67d1" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHA6Ly9naXRodWIuY29tL3Bvc3RhbGpzL3Bvc3RhbC5qcyIsInJlcXVlc3RfaWQiOiJDMzQ1OjM5RjM6MjA2QTdGOjVENzFCQzo2MDgzMjY4RCIsInZpc2l0b3JfaWQiOiIzMTQxNzc0MDQxODQxNjA3MDc1IiwicmVnaW9uX2VkZ2UiOiJpYWQiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=" data-pjax-transient="true"/><meta name="visitor-hmac" content="c4bba804dc7231bf7166c214df6d2ba6b8a662e25c261e14d96547a2d5323ef2" data-pjax-transient="true"/>
      ...
      <div class="d-flex flex-justify-between flex-items-center width-full">
        <a href="https://github.com/" aria-label="Homepage">
          ...
          <div class="font-mktg">
            ...
            <a href="/login?return_to=%2Fjoin_next%3Fref_cta%3DSign%2Bup%26ref_loc%3Dheader%2Blogged%2Bout%26ref_page%3D%252F%253Cuser-name%253E%252F%253Crepo-name%253E%26source%3Dheader-repo%26source_repo%3Dpostaljs%252Fpostal.js" class="color-text-white">
              Log in →
            </a>
          </div>
      </div>
...
<text-suggester class="js-continue-container width-full z-1" style="max-width: 654px;">
  ...
  >
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative js-octocaptcha-parent" action="/join_next" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="7hwMvEyPdI35rxTf+x+XjoibuQXHinEBryTSLkB6p4RrQ5TrTTtTYLCEh3DJDMWRHQ/yake7vLQNTZOPJbtzwA==" />
      <div
        id="email-container"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/email_validity_checks" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="V9SnaDXes/9k6g+PenwIXsG9skf3j08FbLqiJJVm1LjXSZYjXQ+sK7n5gtXGTe8lQ1+drwmSs/oPE1dvas92ww==" />
            </auto-check>
          </div>
          <button
            type="button"
          ...
          <div class="d-flex flex-items-center width-full">
            ...
            <visible-password class="flex-1 d-flex flex-items-center mr-3">
              ...
              >
                ...
                <input type="hidden" data-csrf="true" value="EbPoxaeTFokMYWe0vmEOh1T8pBtUAti/Ldr92aYDAuEJd/KMlgFBI5mfD5MrlkAXsxuL5f13XetMDFB+AfW3nQ==" />
              </auto-check>
              <button
                type="button"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/signup_check/username" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="G1yvG23HZTInxKjLhfCPi9cpyBFCvASlwIVpPArwgWQVY1KcjhPRrVkjpMwbZoQRHlejKqu6NJeF6UcNA4QZBA==" />
            </auto-check>
          </div>
          <button
            type="button"
...
<div class="my-3" >
  ...
  >
        ...
        <input class="form-control" type="text" name="required_field_3b9c" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1619207821829" />
<input class="form-control" type="hidden" name="timestamp_secret" value="3067f32aab43440914c745415ed4d955143c6ec2f445748c205aad5044e9910f" />
