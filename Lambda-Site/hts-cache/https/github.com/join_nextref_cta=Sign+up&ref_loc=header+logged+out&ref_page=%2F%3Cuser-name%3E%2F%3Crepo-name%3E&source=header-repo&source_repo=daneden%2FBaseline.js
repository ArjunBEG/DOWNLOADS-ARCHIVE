...
<html lang="en"  class="height-full"data-color-mode="auto" data-light-theme="light" data-dark-theme="dark">
  ...
  <meta name="request-id" content="C151:13F2:E38825:1518FBC:60832623" data-pjax-transient="true"/><meta name="html-safe-nonce" content="1cd0f425ef50d63593ba0c4a1e928369f0d7310eeade5af7880f6082829b67d1" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHA6Ly9naXRodWIuY29tL2RhbmVkZW4vQmFzZWxpbmUuanMiLCJyZXF1ZXN0X2lkIjoiQzE1MToxM0YyOkUzODgyNToxNTE4RkJDOjYwODMyNjIzIiwidmlzaXRvcl9pZCI6IjMxNDE3NzQwNDE4NDE2MDcwNzUiLCJyZWdpb25fZWRnZSI6ImlhZCIsInJlZ2lvbl9yZW5kZXIiOiJpYWQifQ==" data-pjax-transient="true"/><meta name="visitor-hmac" content="8cd4d50bd203175f5311e0697214fb9572f55f807b581728a087d6cb2e78cf60" data-pjax-transient="true"/>
      ...
      <div class="d-flex flex-justify-between flex-items-center width-full">
        <a href="https://github.com/" aria-label="Homepage">
          ...
          <div class="font-mktg">
            ...
            <a href="/login?return_to=%2Fjoin_next%3Fref_cta%3DSign%2Bup%26ref_loc%3Dheader%2Blogged%2Bout%26ref_page%3D%252F%253Cuser-name%253E%252F%253Crepo-name%253E%26source%3Dheader-repo%26source_repo%3Ddaneden%252FBaseline.js" class="color-text-white">
              Log in →
            </a>
          </div>
      </div>
...
<text-suggester class="js-continue-container width-full z-1" style="max-width: 654px;">
  ...
  >
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative js-octocaptcha-parent" action="/join_next" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="V9FNe8TL2M8E3UKXaKYPWDtHT4E64gGSe+dv4axDjXPSjtUsxX//Ik320ThatV1HrtME7rrTzCfZji5AyYJZNw==" />
      <div
        id="email-container"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/email_validity_checks" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="6E3fxjPKHMxHHhwsn1jiao67n//YZnQwYSFXboILcrZo0O6NWxsDGJoNkXYjaQURDFmwFyZ7iM8CiKIlfaLQzQ==" />
            </auto-check>
          </div>
          <button
            type="button"
          ...
          <div class="d-flex flex-items-center width-full">
            ...
            <visible-password class="flex-1 d-flex flex-items-center mr-3">
              ...
              >
                ...
                <input type="hidden" data-csrf="true" value="CUFL4bE+k5E8xP1deXPpuAedtA8d4CeUDw1nw+3PDPgRhVGogKzEO6k6lXrshKco4Hqb8bSVosBu28pkSjm5hA==" />
              </auto-check>
              <button
                type="button"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/signup_check/username" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="TGznv7PbgSyVbfxfW9E/Czx7ujpfLG1pVcQhOOZPXK5CUxo4UA81s+uK8FjFRzSR9QXRAbYqXVsQqA8J7zvEzg==" />
            </auto-check>
          </div>
          <button
            type="button"
...
<div class="my-3" >
  ...
  >
        ...
        <input class="form-control" type="text" name="required_field_f977" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1619207715359" />
<input class="form-control" type="hidden" name="timestamp_secret" value="3667af58b776b422b919bb28a1a5761c3259e2a7a52ab424feaadb18b279fc1f" />
