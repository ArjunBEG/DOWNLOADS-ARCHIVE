...
<html lang="en"  class="height-full"data-color-mode="auto" data-light-theme="light" data-dark-theme="dark">
  ...
  <meta name="request-id" content="D21C:74B5:AA11EA:11D3EE3:60833AC2" data-pjax-transient="true"/><meta name="html-safe-nonce" content="1cd0f425ef50d63593ba0c4a1e928369f0d7310eeade5af7880f6082829b67d1" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHA6Ly9naXRodWIuY29tL1dpY2t5TmlsbGlhbXMvZW5xdWlyZS5qcyIsInJlcXVlc3RfaWQiOiJEMjFDOjc0QjU6QUExMUVBOjExRDNFRTM6NjA4MzNBQzIiLCJ2aXNpdG9yX2lkIjoiMzE0MTc3NDA0MTg0MTYwNzA3NSIsInJlZ2lvbl9lZGdlIjoiaWFkIiwicmVnaW9uX3JlbmRlciI6ImlhZCJ9" data-pjax-transient="true"/><meta name="visitor-hmac" content="7fe9b8c8a329ac2c9a93908965ff3fa7eab69b69036c85b24b31c8cdc376561e" data-pjax-transient="true"/>
  ...
  <link crossorigin="anonymous" media="all" integrity="sha512-FvpHNjOTG33ev42GDUKT/aPuLLwh+u2GAJuXbKkqweK1/KxTlpu0dqCgygR4ystACNdRoXKwYM6y7XFtQqTzCw==" rel="stylesheet" href="https://github.githubassets.com/assets/home-16fa473633931b7ddebf8d860d4293fd.css" />
      ...
      <div class="d-flex flex-justify-between flex-items-center width-full">
        <a href="https://github.com/" aria-label="Homepage">
          ...
          <div class="font-mktg">
            ...
            <a href="/login?return_to=%2Fjoin_next%3Fref_cta%3DSign%2Bup%26ref_loc%3Dheader%2Blogged%2Bout%26ref_page%3D%252F%253Cuser-name%253E%252F%253Crepo-name%253E%26source%3Dheader-repo%26source_repo%3DWickyNilliams%252Fenquire.js" class="color-text-white">
              Log in →
            </a>
          </div>
      </div>
...
<text-suggester class="js-continue-container width-full z-1" style="max-width: 654px;">
  ...
  >
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="position-relative js-octocaptcha-parent" action="/join_next" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="wrdBavEzClQwYWY7guo4/azsO5bza9xdpS7e7E4jc/BH6Nk98IctuXlK9ZSw+WriOXhw+XNaEegHR59NK+KntA==" />
      <div
        id="email-container"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/email_validity_checks" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="uOfJyrBKwVdbdW84KwPV5A+v81wRxd3D8IrgmGeyvYQ4eviB2Jveg4Zm4mKXMjKfjU3ctO/YITyTIxXTmBsf/w==" />
            </auto-check>
          </div>
          <button
            type="button"
          ...
          <div class="d-flex flex-items-center width-full">
            ...
            <visible-password class="flex-1 d-flex flex-items-center mr-3">
              ...
              >
                ...
                <input type="hidden" data-csrf="true" value="CAqrVGT+/3dZpz97XR3yS1hki+C/paTgYnvEMx7U9asQzrEdVWyo3cxZV1zI6rzbv4OkHhbQIbQDrWmUuSJA1w==" />
              </auto-check>
              <button
                type="button"
        ...
        <div class="d-flex flex-items-center flex-column flex-sm-row">
          <div class="d-flex flex-items-center width-full">
            ...
            <auto-check src="/signup_check/username" class="js-prevent-default-behavior width-full" required>
              ...
              <input type="hidden" data-csrf="true" value="89kY4Xr64O/2zSjG3/5KgPRvPhs12lyHznAJ02eUtHn95uVmmS5UcIgqJMFBaEEaPRFVINzcbLWLHCfibuAsGQ==" />
            </auto-check>
          </div>
          <button
            type="button"
...
<div class="my-3" >
  ...
  >
        ...
        <input class="form-control" type="text" name="required_field_b54b" hidden="hidden" />
<input class="form-control" type="hidden" name="timestamp" value="1619212994314" />
<input class="form-control" type="hidden" name="timestamp_secret" value="d0eb912a3f0bf2881188b5c8c7d74fdd2f66843a9d78909257c34996f7738fc8" />
