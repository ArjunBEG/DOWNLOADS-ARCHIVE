...
<title>/2-resources/netlify-functions/node_modules/@nodelib/fs.stat/src/providers</title>
...
<tr><td><a href="left.html" target="_parent">left.html</a>&nbsp;</td><td><a href="async.spec.ts" target="_parent">async.spec.ts</a>&nbsp;</td><td><a href="async.ts" target="_parent">async.ts</a>&nbsp;</td><td><a href="sync.spec.ts" target="_parent">sync.spec.ts</a>&nbsp;</td><td><a href="sync.ts" target="_parent">sync.ts</a>&nbsp;</td></tr>
</table>

<p class="summary-style">
Folders:  1<br>
Files: 5<br>
Size of all files: 22773 KB</p>
